...
export default function LegalHackPage() {
  ...
  return (
    <div className="fixed inset-0 pt-20 bg-[#00002c] flex flex-col">
      ...
      <div className="bg-[#00002c]/95 border-b border-white/10 p-4 flex items-center justify-between flex-shrink-0">
        ...
        <h1 className="text-xl font-bold text-white">START Legal Hack</h1>
      ...
      <div className="flex-1 w-full overflow-hidden">
        <iframe
          src="https://www.hacking-legal.org/"
          className="w-full h-full border-0"
          title="START Legal Hack"
          allowFullScreen
        />
      </div>
    </div>
